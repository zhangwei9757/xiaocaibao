 ...
 */
@Component
public class GroovyFileScriptFactoryPostProcessor extends InstantiationAwareBeanPostProcessorAdapter implements
	...
	public Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) {
		...
		if (refreshCheckDelay >= 0) {
			...
			if (proxyTargetClass && (language == null || !language.equals("groovy"))) {
				...
				"Cannot use proxyTargetClass=true with script beans where language is not 'commands': '" +
				language + "'");
			}
