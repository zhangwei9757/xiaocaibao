...
public class SLNode<K extends Comparable<K>, V extends Comparable<V>> implements Comparable<SLNode<K, V>> {
    private K member;
    private V score;
    private SLNode<K, V> backward = null;
    private List<SLNodeLevel<K, V>> levels = new ArrayList<>();
