...
//	public static final int 其他活动周期 = 5;
	...
	public static final int 矿区等级 = 32;
	...
	public static final String ARENA_PREFIX = "http://Arena006";
	public static final String GUILD_PREFIX = "http://Guild006";
	...
	public static boolean isArtifact(int id) { return (id > 40000 && id < 42000); }

//	public static boolean isCoinID(int id) {
//		return (id >= 0 && id < 5000);
//	}
//
//	public static boolean isItemID(int id) {
//		return (id >= 5000 && id < 10000);
//	}
}
