...
class BossService implements IBossSystem {
     ...
     */
    public void checkBossBean(boolean force) {
     ...
     * @return
     */
    public synchronized long bossLife() {
     ...
     * @return
     */
    public List<BossRoleDto> getRanks() {
     ...
     * @return
     */
    public List<BossGuildDto> getGuildRanks() {
     ...
     * @return
     */
    public BossDto getInfo(long uid, String name) {
