        ...
        try {
            ...
            if (signtype != null) {
                ...
                if (result == 0) {
                     ...
                     */
                    if (bpb != null && SignHelper.verify(transdata, sign, bpb.getPlatkey())) {
                        // 1. 订单号
...
class Order {
    ...
    static String ReqData(AibeiParam bpb, int waresid, String cporderid, float price, String appuserid, String cpprivateinfo, String notifyurl) {
        ...
        String sign = SignHelper.sign(content, bpb.getPrivatekey())
    ...
    static String CheckSign(AibeiParam bpb, int waresid, String cporderid, float price, String appuserid, String cpprivateinfo, String notifyurl) {
        ...
        if (signtype != null) {
            try {
                if (SignHelper.verify(transdata, resultMap.get("sign"), bpb.getPlatkey())) {
    ...
    public static String H5orPCpay(AibeiParam bpb, String transid) {
