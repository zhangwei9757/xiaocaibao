 ...
 * &lt;/bean&gt;
 *
 * &lt;bean id="groovyMessenger" class="org.springframework.scripting.commands.GroovyScriptFactory"&gt;
 *   &lt;constructor-arg value="classpath:mypackage/Messenger.commands"/&gt;
 *   &lt;property name="message" value="Hello World!"/&gt;
 * &lt;/bean&gt;</pre>
 *
 ...
 * a Groovy-backed bean defined using the {@code 'lang:commands'} tag.
 *
 * <pre class="code">
 ...
 *   &lt;lang:commands id="messenger" script-source="classpath:Messenger.commands"&gt;
 ...
 */
@Component
public class GroovyFileScriptFactoryPostProcessor extends InstantiationAwareBeanPostProcessorAdapter implements BeanClassLoaderAware, BeanFactoryAware, ResourceLoaderAware, DisposableBean, Ordered {
	...
	public Object postProcessBeforeInstantiation(Class<?> beanClass, String beanName) {
		...
		if (refreshCheckDelay >= 0) {
			Class<?>[] interfaces = scriptFactory.getScriptInterfaces();
			ReplaceAndRefreshableScriptTargetSource ts = new ReplaceAndRefreshableScriptTargetSource(this.scriptBeanFactory, scriptedObjectBeanName, scriptFactory, scriptSource, isFactoryBean);

			boolean proxyTargetClass = resolveProxyTargetClass(bd);
			String language = (String) bd.getAttribute(LANGUAGE_ATTRIBUTE);
			if (proxyTargetClass && (language == null || !language.equals("groovy"))) {
				throw new BeanDefinitionValidationException( "Cannot use proxyTargetClass=true with script beans where language is not 'commands': '" + language + "'");
			}
...
//				logger.info("-------------------- 注册scriptObjectBean:" + scriptedObjectBeanName + " factory:" + scriptFactoryBeanName);
