...
public class GenUtil {
	...
	public GenUtil(long idepoch) {
		this(r.nextInt((int) maxWorkerId), r.nextInt((int) maxDatacenterId), 0, idepoch);
	}

	public GenUtil(long workerId, long datacenterId, long sequence) {
		this(workerId, datacenterId, sequence, 1344322705519L);
	}

	//
	public GenUtil(long workerId, long datacenterId, long sequence, long idepoch) {
