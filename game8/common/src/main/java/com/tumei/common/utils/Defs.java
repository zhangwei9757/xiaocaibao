...
public class Defs {
	...
	public static final String arena_prefix = "http://arena008";
	public static final String guild_prefix = "http://guild008";
	public static final String center_prefix = "http://center008";
	public static final String xxkg_prefix = "http://xxkg008";
