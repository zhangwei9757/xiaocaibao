 ...
 *
 */
class GroovyBattle implements IBattle {
    private static final Log log = LogFactory.getLog(GroovyBattle.class)
        ...
        for (int i = 0; i < 6; ++i) {
            ...
            if (hb != null) {
                ...
                if (wuz) {
                    ...
                    switch (hc.name) {
                        case "审判者":
                            role = new 审判者(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "林妖":
                            role = new 林妖(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "银飞马":
                            role = new 银飞马(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "独角神兽":
                            role = new 独角神兽(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "大祭司":
                            role = new 大祭司(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "光灵":
                            role = new 光灵(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "十字军":
                            role = new 十字军(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "树精卫士":
                            role = new 树精卫士(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "皇家骑士":
                            role = new 皇家骑士(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "独眼巨人":
                            role = new 独眼巨人(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "沙漠飞龙":
                            role = new 沙漠飞龙(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "飞龙王":
                            role = new 飞龙王(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "巨蜥":
                            role = new 巨蜥(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "萨满":
                            role = new 萨满(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "蛮牛":
                            role = new 蛮牛(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "食人魔":
                            role = new 食人魔(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "毒蜥骑士":
                            role = new 毒蜥骑士(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "雷鸟":
                            role = new 雷鸟(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "恐怖骑士":
                            role = new 恐怖骑士(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "吸血鬼":
                            role = new 吸血鬼(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "邪神王":
                            role = new 邪神王(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "烈火精灵":
                            role = new 烈火精灵(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "纺命蛛后":
                            role = new 纺命蛛后(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "尸巫王":
                            role = new 尸巫王(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "恶鬼":
                            role = new 恶鬼(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "魅魔":
                            role = new 魅魔(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "地狱战马":
                            role = new 地狱战马(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "美杜莎":
                            role = new 美杜莎(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "奥术神鹰":
                            role = new 奥术神鹰(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "毒蝎狮":
                            role = new 毒蝎狮(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "巨像":
                            role = new 巨像(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "神怪主":
                            role = new 神怪主(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "离魂者":
                            role = new 离魂者(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "牛头王":
                            role = new 牛头王(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "那加女王":
                            role = new 那加女王(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "大法师":
                            role = new 大法师(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "大天使":
                            role = new 大天使(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "金龙":
                            role = new 金龙(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "比蒙":
                            role = new 比蒙(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "九头蛇":
                            role = new 九头蛇(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "大恶魔":
                            role = new 大恶魔(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "鬼龙":
                            role = new 鬼龙(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "泰坦巨人":
                            role = new 泰坦巨人(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        case "黑龙":
                            role = new 黑龙(this, side, i, hb, herosBean.lineups[i], skin, skin_level)
                            break
                        default:
        ...
        for (Roler role : his) {
            ...
            if (side == 2) {
                if (weak > 0) {
                    ...
                    role.max_life = role.max_life * w
                    role.life = role.max_life
                    role.attack = role.attack * w
                    role.defs = role.defs * w
                    role.mdef = role.mdef * w
                }
            }
            speed += role.speed
...
class Roler {
    ...
    Roler(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        this.battle = battle
        this.side = side
        this.index = idx
        ...
        if (hb.gift > 0) {
            ...
            if (hb.giftrunes[0] != 0) { // 攻击, 本级激活
                if (mode == GroovyBattle.物理攻击 || mode == GroovyBattle.法术攻击) {
    ...
    Roler(GroovyBattle battle, int side, int idx, DirectHeroStruct hb) {
        this.battle = battle
        this.side = side
        this.index = idx
     ...
     * @param side
     */
    Roler(GroovyBattle battle, int side) {
        this.battle = battle
        this.side = side
        this.index = 6 // 第七个人
    }
 ...
 * 武装角色 特殊处理
 */
class 审判者 extends Roler {
    审判者(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
}

class 林妖 extends Roler {

    林妖(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 银飞马 extends Roler {

    银飞马(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 独角神兽 extends Roler {

    独角神兽(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }

    @Override
    double onPunch(Roler attacker, double harm) {
        if (attacker.mode == GroovyBattle.法术攻击 || attacker.mode == GroovyBattle.辅助攻击) {
            HeroSkillConf hc = battle.readonly.findSkill(this.id)
            if (battle.getRandom() <= hc.skillzeff[0]) {
                // 反弹伤害
...
class 大祭司 extends Roler {

    大祭司(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 光灵 extends Roler {

    光灵(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 十字军 extends Roler {

    十字军(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 树精卫士 extends Roler {

    树精卫士(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 皇家骑士 extends Roler {

    皇家骑士(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 独眼巨人 extends Roler {

    独眼巨人(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 沙漠飞龙 extends Roler {

    沙漠飞龙(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 飞龙王 extends Roler {

    飞龙王(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
    ...
    void afterDoHarm(Roler target, double harm, boolean isDodge, boolean isPeerDead, boolean isCrit) {
        ...
        if (battle.getRandom() <= hc.skillzeff[0]) {
            battle.getCurrent().wuz = 1
            target.addBuff(new 飞龙王毒Buff(target, hc.skillzeff[2], hc.skillzeff[1]))
        }
    }
}

class 巨蜥 extends Roler {

    巨蜥(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 萨满 extends Roler {

    萨满(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 蛮牛 extends Roler {

    蛮牛(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 食人魔 extends Roler {

    private boolean addBuff = false

    食人魔(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 毒蜥骑士 extends Roler {

    毒蜥骑士(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 雷鸟 extends Roler {

    雷鸟(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 恐怖骑士 extends Roler {

    恐怖骑士(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 吸血鬼 extends Roler {

    吸血鬼(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 邪神王 extends Roler {

    邪神王(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 烈火精灵 extends Roler {

    烈火精灵(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 纺命蛛后 extends Roler {

    纺命蛛后(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 尸巫王 extends Roler {

    尸巫王(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 恶鬼 extends Roler {

    恶鬼(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 魅魔 extends Roler {

    魅魔(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 地狱战马 extends Roler {
    地狱战马(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
}

class 美杜莎 extends Roler {

    美杜莎(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 奥术神鹰 extends Roler {

    奥术神鹰(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 毒蝎狮 extends Roler {

    毒蝎狮(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 巨像 extends Roler {

    巨像(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 神怪主 extends Roler {

    神怪主(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 离魂者 extends Roler {

    离魂者(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 牛头王 extends Roler {

    牛头王(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
        moral += 8
    }
...
class 那加女王 extends Roler {

    那加女王(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 大法师 extends Roler {
    大法师(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
}

class 大天使 extends Roler {
    private boolean recurrsive = false

    大天使(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 金龙 extends Roler {
    金龙(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 比蒙 extends Roler {

    比蒙(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
        this.force_attack = 100
    }
}

class 九头蛇 extends Roler {
    private double ex_crit

    九头蛇(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 大恶魔 extends Roler {

    大恶魔(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
        HeroSkillConf hc = battle.readonly.findSkill(this.id)
...
class 鬼龙 extends Roler {

    鬼龙(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 泰坦巨人 extends Roler {

    泰坦巨人(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class 黑龙 extends Roler {
    private boolean once_buff

    黑龙(GroovyBattle battle, int side, int idx, HeroStruct hb, int lineup, int skin, int skin_level) {
        super(battle, side, idx, hb, lineup, skin, skin_level)
    }
...
class ActionRecord {
    ...
    String debug(GroovyBattle battle, Roler roler, int _ri) {
...
//    static final int 加攻类型 = 108
    ...
    static final int 飞龙王毒 = 302  // 飞龙王 互斥 刷新回合
...
class 飞龙王毒Buff extends BuffInfo {
    /**
     * 每个回合降低的生命上限
     */
    private double life
    ...
    飞龙王毒Buff(Roler hi, int round, int ratio) {
        super(hi)
        this.round = round
    ...
    void onAddStatus() {
        super.onAddStatus()
        heroInfo.getBattle().getCurrent().addEffectHarm(heroInfo, 飞龙王毒, 1, false)
    }
