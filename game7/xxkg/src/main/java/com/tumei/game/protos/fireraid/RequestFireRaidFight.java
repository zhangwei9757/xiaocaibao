...
//		RoleBean rb = user.getDao().findRole(user.getUid());
		...
		if (mode == 0) {
			...
			FightResult r = GameServer.getInstance().getBattleSystem().doSceneBattle(hsb.createHerosStruct(), fc.makeFireRaid(), fc.condition, false, fc.glory[0], fc.glory[1], fc.glory[2], fc.glory[3]);
