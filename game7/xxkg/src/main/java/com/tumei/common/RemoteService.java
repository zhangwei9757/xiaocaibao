...
public class RemoteService extends BaseRemoteService {
    ...
    public void askPaymentValidation(long gid, long role, int mode, String userName) {
        try {
            String url = guild_prefix + "/paymentValidation?gid=" + gid + "&role=" + role + "&mode=" + mode + "&userName=" + userName;
    ...
    public List<GuildbagBasicDto> askGuildBagList(long gid, long role) {
        try {
    ...
    public GuildbagDetailDto askGuildBagReceive(long gid, long role, String name, String bagId) {
        try {
            String url = guild_prefix + "/guildBagReceive?gid=" + gid + "&role=" + role + "&name=" + name + "&bagId=" + bagId;
            return restTemplate.getForObject(url, GuildbagDetailDto.class);
        } catch (Exception ex) {
