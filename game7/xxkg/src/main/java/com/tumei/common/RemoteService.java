...
public class RemoteService extends BaseRemoteService {
    ...
    public void askDonateSuccess(long gid, long role, int mode) {
        try {
            String url = guild_prefix + "/donateSuccess?role=" + role + "&gid=" + gid + "&mode=" + mode;
    ...
    public String askPaymentValidation(long gid, long role, int progress, int exp, int contrib) {
        try {
            String url = guild_prefix + "/donate?role=" + role + "&gid=" + gid + "&pg=" + progress + "&exp=" + exp + "&cb=" + contrib;
            return restTemplate.getForObject(url, String.class);
        } catch (Exception ex) {
    ...
    public String askGuildBagList(long gid, long role, int progress, int exp, int contrib) {
        try {
            String url = guild_prefix + "/donate?role=" + role + "&gid=" + gid + "&pg=" + progress + "&exp=" + exp + "&cb=" + contrib;
            return restTemplate.getForObject(url, String.class);
        } catch (Exception ex) {
    ...
    public String askGuildBagReceive(long gid, long role, int progress, int exp, int contrib) {
        try {
            String url = guild_prefix + "/donate?role=" + role + "&gid=" + gid + "&pg=" + progress + "&exp=" + exp + "&cb=" + contrib;
            return restTemplate.getForObject(url, String.class);
        } catch (Exception ex) {
