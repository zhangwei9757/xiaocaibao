...
public class DaoCenter {
	final static Log log = LogFactory.getLog(DaoCenter.class);
	...
	public void initialize() {
		...
		userBeanLoadingCache = gameCache.cached(new CacheLoader<Long, UserBean>() {
			@Override
		...
		dailyStaBeanLoadingCache = gameCache.cached(new CacheLoader<Integer, DailyStaBean>() {
			@Override
